...
<nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    ...
    <div class="scrollbar-inner">
        ...
        <div class="sidenav-header d-flex align-items-center">
            ...
            <img src="./img/space.png" class="navbar-brand-img" alt="..." style="max-height: fit-content;">
            </a>
            <div class="ml-auto">
                <!-- Sidenav toggler -->
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <?php   $arr = get_menu($menu,'active','show'); ?>

                    <li class="nav-item">
                        <a class="nav-link"  href="<?php $options->adminUrl('write-post.php'); ?>">
                            <i class=" ni ni-align-left-2 text-d texlt"></i>
                            <span class="nav-link-text">撰写文章</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php $options->adminUrl('manage-comments.php?status=spam'); ?>">
        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav align-items-center ml-auto ml-md-0">
                    ...
                    &nbsp;
                    <li class="nav-item dropdown">
                        <a href="<?php $options->logoutUrl(); ?>" class="btn btn-danger btn-sm" style="display: inline-flex;align-items: center;">登出</a>
                        <a href="<?php $options->siteUrl(); ?>" class="btn btn-secondary btn-sm " style="display: inline-flex;align-items: center;">网站</a>
                    </li>
                </ul>
            </div>
        </div>
