                        ...
                        <form method="get">
                            ...
                            <div id="datatable-buttons_filter" class="dataTables_filter">
                                <div class="search" role="search">
                                    ...
                                    <?php endif; ?>
                                    <input type="text" class="text-s form-control form-control-sm" style="padding: 0 0 0 3px;height: 32px;" placeholder="<?php _e('请输入关键字'); ?>" value="<?php echo htmlspecialchars($request->keywords ?? ''); ?>" name="keywords" />
