                                        ...
                                        <div class="d-flex w-100 justify-content-between">
                                            <div>
                                                <div class="d-flex w-100 align-items-center">
                                                    <img src="<?php echo Typecho_Common::gravatarUrl($comments->mail, 65, 'G', '0', $request->isSecure()) . '" alt="' . $user->screenName?>" alt="Image placeholder" class="avatar avatar-xs mr-2">
