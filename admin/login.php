            ...
            <div class="container">
                <div class="form">
                    ...
                    <form action="<?php $options->loginAction(); ?>" method="post" name="login" role="form">
                        <div class="inputBox">
                            <input type="text" id="name" name="name" value="<?php echo $rememberName; ?>" placeholder="<?php _e('ID'); ?>" autofocus>

                        </div>
                        <div class="inputBox">
                            <input type="password" id="password" name="password" placeholder="<?php _e('通行证'); ?>">
